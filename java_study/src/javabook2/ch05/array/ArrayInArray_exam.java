...
public class ArrayInArray_exam {
	...
	public static void main(String[] args) {
		...
		// 2차원 0번인덱스 배열 길이(1반인원수)
		System.out.println(scores[0].length);	
		// 2차원 1번인덱스 배열길이(2반인원수)
		...
		int sum1 = 0;
		System.out.println("===================");
		System.out.println("2반 학생들 점수 총합: ");
		for(int i = 0; i < scores[1].length; i++) {
		sum1 += scores[1][i];
		}
		...
		// [문제3] 1반 학생들 점수 평균
		System.out.println("===================");
		System.out.println("1반 학생들 점수 평균: ");
		int avg = sum / scores[0].length;
		System.out.println("평균: "+ avg + "점");
			
		double dAvg = (double)sum/  scores[0].length;
		System.out.println("평균: "+ dAvg + "점");
				
		
		// [문제4] 2반 학생들 점수 평균
		System.out.println("===================");
		System.out.println("2반 학생들 점수 평균: ");
		int avg1 = sum1 / scores[1].length;
		System.out.println("평균: "+ avg1 + "점");
		
		double dAvg1 = (double)sum1/  scores[1].length;
		...
		// [문제5] 전체 학생들 점수 총합
		System.out.println("======================");
		System.out.println("전체 학생들 점수 총합:");
//		for(int i= 0; i< scores[0].length; i++) {
...
//			System.out.println(scores[0][i]);
		...
		System.out.println(sum + "점");
		double dAvg2 = (double)sum /count;
		System.out.println("평균: "+ dAvg2 + "점");
	}
